...
$sql = "select cast(`entrytime` as date) Date,`curr_page_url` as Page,cast(avg(`time_spent`) as decimal(18,2)) as 'TimeSpent on Page' from tbl_page_performance_details group by cast(`entrytime` as date),`curr_page_url`"; 
